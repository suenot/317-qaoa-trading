# Chapter 187: QAOA для Trading

## Описание

Quantum Approximate Optimization Algorithm для комбинаторных задач.
...
1. **PO-QA: A Framework for Portfolio Optimization using Quantum Algorithms**
   - URL: https://arxiv.org/abs/2407.19857
   - Год: 2024
